...
- `STORAGE_*` - Cloudflare R2 (S3-compatible) storage configuration (`STORAGE_ENDPOINT`, `STORAGE_BUCKET`, `STORAGE_ACCESS_KEY`, `STORAGE_SECRET_KEY`, optional `STORAGE_REGION=auto` / `STORAGE_DOMAIN`)
