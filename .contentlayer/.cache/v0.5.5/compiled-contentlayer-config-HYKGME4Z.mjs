...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      title: "Smart-Pixels\u2014A Deep Dive into Visual Intelligence with AI",
      author: "Tim",
      headerTitle: "Smart-Pixels",
      description: "Your guide to AI image generation. We provide deep dives into new models, practical tutorials and tool reviews to keep you at the forefront of visual AI.",
      language: "en-us",
      theme: "system",
...
//# sourceMappingURL=compiled-contentlayer-config-HYKGME4Z.mjs.map
